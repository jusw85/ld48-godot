...
func fade_out() -> void:
	...
	_fade_out_tween.interpolate_property(_audio_stream, "volume_db", 0, -80, transition_duration, Tween.TRANS_SINE, Tween.EASE_IN, 0)
	_fade_out_tween.start()

func fade_in() -> void:
	_fade_in_tween.stop_all()
	_fade_in_tween.interpolate_property(_audio_stream, "volume_db", -80, 0, transition_duration, Tween.TRANS_SINE, Tween.EASE_IN, 0)
